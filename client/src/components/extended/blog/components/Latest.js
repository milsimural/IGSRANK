...
export default function Latest() {
    ...
    return (React.createElement("div", null,
        React.createElement(Typography, { variant: "h2", gutterBottom: true }, "Latest"),
        React.createElement(Grid, { container: true, spacing: 8, columns: 12, sx: { my: 4 } }, articleInfo.map((article, index) => (
        // eslint-disable-next-line react/no-array-index-key
        React.createElement(Grid, { key: index, size: { xs: 12, sm: 6 } },
            React.createElement(Box, { sx: {
                ...
                React.createElement(Typography, { gutterBottom: true, variant: "caption", component: "div" }, article.tag),
                React.createElement(TitleTypography, { gutterBottom: true, variant: "h6", onFocus: () => handleFocus(index), onBlur: handleBlur, tabIndex: 0, className: focusedCardIndex === index ? 'Mui-focused' : '' },
                    article.title,
                    React.createElement(NavigateNextRoundedIcon, { className: "arrow", sx: { fontSize: '1rem' } })),
                React.createElement(StyledTypography, { variant: "body2", color: "text.secondary", gutterBottom: true }, article.description),
                React.createElement(Author, { authors: article.authors })))))),
        React.createElement(Box, { sx: { display: 'flex', flexDirection: 'row', pt: 4 } },
            React.createElement(Pagination, { hidePrevButton: true, hideNextButton: true, count: 10, boundaryCount: 10 }))));
}
