...
import type { RatingType, ApiRatingResponseType } from 'src/components/types/rating';
...
import type { CityType } from 'src/DATA/CityType';
...
export default function MainGrid(): JSX.Element {
  const [rating, setRating] = React.useState<RatingType[]>([]);
  const menuActivePoint = useSelector((state: RootState) => state.menu.menuActivePoint);
