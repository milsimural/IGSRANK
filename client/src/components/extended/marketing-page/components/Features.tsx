...
const items = [
  {
    ...
    description:
      'Изменения цен конкурентов, новые продукты и акции, положение сайта в поиске и их затраты на рекламу — все на одном экране.',
  ...
  },
  {
    ...
    description:
      'Данные о рынке обновляются каждую ночь, поэтому вы всегда в курсе актуальной информации и можете сравнить ее с предыдущим периодом.',
    ...
    <Container id="features" sx={{ py: { xs: 8, sm: 16 } }}>
      <Box sx={{ width: { sm: '100%', md: '60%' } }}>
        ...
        <Typography variant="body1" sx={{ color: 'text.secondary', mb: { xs: 2, sm: 4 } }}>
          Будте в курсе того что делают маркетологи ваших конкурентов.
        </Typography>
      </Box>
      <Box
        sx={{
